...
[![My Skills](https://skillicons.dev/icons?i=linux,js,github,git,angular,figma,bootstrap,tailwind,typescript,nodejs,php,vercel,java,kotlin,golang,expressjs,go,astro,bun,redux,docker,supabase,netlify,python)](https://skillicons.dev)
